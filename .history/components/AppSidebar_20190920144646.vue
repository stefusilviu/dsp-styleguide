<template>
  <el-menu class="side-menu" :collapse="collapsed" :router="true" :unique-opened="true" :default-active="$nuxt.$route.path" active-text-color="#04816A">
    ...
    <menu-toggle @togglemenu="toggle" :collapse="collapsed"></menu-toggle>
